...
public class MazemapTest {
	...
	Assertions.assertThrows(IllegalArgumentException.class, () -> {MazeMap myMazeMap2 = new MazeMap(0,2, myPassable );});
	
	Assertions.assertThrows(IllegalArgumentException.class, () -> {MazeMap myMazeMap3 = new MazeMap(1,0, myPassable);});
	
	Assertions.assertThrows(IllegalArgumentException.class, () -> {MazeMap myMazeMap4 = new MazeMap(1,2, null );});
	
	Assertions.assertThrows(IllegalArgumentException.class, () -> {MazeMap myMazeMap5 = new MazeMap(3,2, myPassable );});
